...
Note that this function implicitly calls \verb|dbScanLock| or in some circumstances \verb|dbScanLockMany|.
...
Database links can be changed at run time but only via a channel access client,
