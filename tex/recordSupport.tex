...
\index{udf}
Database common defines the field \index{UDF}UDF, which should be set when the field VAL is undefined.
...
\item \index{DBE\_LOG}DBE\_LOG - Archived value update.

\item \index{DBE\_VAL}DBE\_VAL - Value update.

\item \index{DBE\_PROPERTY}DBE\_PROPERTY - Value property update.
